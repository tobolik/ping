        ...
        <div class="h-screen flex flex-col w-full">
            <header class="bg-white/90 backdrop-blur-sm p-2 md:p-3 shadow-sm text-center flex justify-between items-center w-full z-10 flex-shrink-0">
                ...
                <div class="w-36 md:w-48 flex justify-end gap-1 md:gap-2">
                    ...
                    <button data-action="toggle-voice-assist-ingame" class="btn btn-secondary !p-0 h-10 w-10 md:h-12 md:w-12 text-lg md:text-xl ${state.settings.voiceAssistEnabled ? 'text-blue-600' : 'text-gray-400'}" title="Zapnout/vypnout hlas">${state.settings.voiceAssistEnabled ? '<i class="fa-solid fa-comment-dots"></i>' : '<i class="fa-solid fa-comment-slash"></i>'}</button>
                    <button data-action="toggle-motivational-phrases-ingame" class="btn btn-secondary !p-0 h-10 w-10 md:h-12 md:w-12 text-lg md:text-xl ${state.settings.motivationalPhrasesEnabled ? 'text-green-600' : 'text-gray-400'}" title="Zapnout/vypnout motivační hlášky">${state.settings.motivationalPhrasesEnabled ? '<i class="fa-solid fa-comments"></i>' : '<i class="fa-solid fa-ban"></i>'}</button>
                    <button data-action="toggle-sound-ingame" class="btn btn-secondary !p-0 h-10 w-10 md:h-12 md:w-12 text-lg md:text-xl ${state.settings.soundsEnabled ? 'text-blue-600' : 'text-gray-400'}" title="Zapnout/vypnout zvuky">${state.settings.soundsEnabled ? '<i class="fa-solid fa-volume-high"></i>' : '<i class="fa-solid fa-volume-xmark"></i>'}</button>
                </div>
            </header>
